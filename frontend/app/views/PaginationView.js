define([
  ...
  /**
   * @name app.views.PaginationView
   * @constructor
   * @extends {app.views.View}
   * @param {object} options
   * @param {app.models.PaginationData} options.model
   */
  ...
  PaginationView.prototype.serialize = function()
  {
    ...
    return {
      ...
      firstPageLinkAvailable: currentPage > 2,
      lastPageLinkAvailable: currentPage < (pageCount - 1),
